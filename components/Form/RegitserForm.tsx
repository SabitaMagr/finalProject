...
const RegitserForm = ({ state, setState }: RegisterProps) => {
    ...
    return (
        ...
        <form action="" onSubmit={handleSubmit(saveRegisterForm)} className=" w-[40%] z-50 flex-col bg-[#f0f1f5] flex gap-2 border rounded-lg">
            ...
            <div className='flex-col flex gap-5 justify-center pb-3 px-20'>
                ...
                <div className=''>
                    <div className='flex gap-5 items-center'>
                        <span><FaAddressCard size={24} /></span>
